    ...
    <div>
          ...
          <div className="card text-left p-1">
            <div className="card-body p-3">
              ...
              <p>
                ...
                the addition of the hover styles here not present in the
                previous example. Also supported is the .active state; apply it
                to indicate an active selection on a contextual list group item.
              </p>
              <div className="list-group">
      ...
      <div className="row mb-4">
        ...
        <div className="col-md-8">
          <div className="card text-left p-1">
            <div className="card-body p-3">
              <h4 className="card-title mb-2">List With JavaScript behavior</h4>
                  ...
                  <div className="col-md-8">
                    <Tab.Content className="p-0">
                      <Tab.Pane eventKey="first">
                        {randomText.slice(0, 1000)}
                      </Tab.Pane>
                      <Tab.Pane eventKey="second">
                        {randomText.slice(0, 500)}
                      </Tab.Pane>
                      <Tab.Pane eventKey="third">
                        {randomText.slice(0, 750)}
                      </Tab.Pane>
                      <Tab.Pane eventKey="fourth">
                        {randomText.slice(0, 850)}
                      </Tab.Pane>
                    </Tab.Content>
                  </div>
                </div>
